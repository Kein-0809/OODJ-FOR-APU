...
public class Sample2_02drive {
  public static void main(String[] args) {

    //シナリオ①：車を場に登場させる(Sample1_car.javaファイルにある「Sample1_carクラス」のインスタンス化)
    System.out.println("▼シナリオ①：車を場に登場させる------------------") ;
		
		Sample2_02car chocoCar = new Sample2_02car();
		Sample2_02car mocoCar  = new Sample2_02car( "クーペ"   , "モコ" , "RED"   , 100 , true );
		Sample2_02car pochiCar = new Sample2_02car( "トラック" , "ポチ" , "WHITE" , 80  , true );
