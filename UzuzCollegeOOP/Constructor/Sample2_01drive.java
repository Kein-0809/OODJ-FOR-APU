...
public class Sample2_01drive {
  public static void main(String[] args) {

    //シナリオ①：車を場に登場させる(Sample1_car.javaファイルにある「Sample1_carクラス」のインスタンス化)
    System.out.println("▼シナリオ①：車を場に登場させる------------------") ;
		
		Sample2_01car chocoCar = new Sample2_01car();
		Sample2_01car mocoCar  = new Sample2_01car( "クーペ"   , "モコ" , "RED"   , 100 , true );
		Sample2_01car pochiCar = new Sample2_01car( "トラック" , "ポチ" , "WHITE" , 80  , true );
