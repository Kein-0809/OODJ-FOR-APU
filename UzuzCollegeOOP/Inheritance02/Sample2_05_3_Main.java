...
class Sample2_05_3_Main {
	public static void main (String[] args) {
		...
		//! 「moco」という名前のインスタンス化先の「Sample2_05_3_ToyPoodle」というクラス内で「toString()」メソッドを使っているためインスタンス化時に仮引数を参照して初期化したフィールドの値が参照することができる
		...
		//! 「pochi」という名前のインスタンス化のデータが格納されてある場所が表示される
